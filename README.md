...
assets/         the four photos, shared by all three designs
...
- The team lineup photo carries a photographer's watermark in the original.
  It is cropped out here for the demo. **Permission is needed before launch.**
- Both team photos show identifiable minors. Releases are needed for commercial
  use.
